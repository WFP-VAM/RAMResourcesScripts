...
* Define labels
variable labels 
    rCSILessQlty       "Relied on less preferred, less expensive food"
    ...
    rCSIMealAdult      "Restrict consumption by adults in order for young-children to eat".
