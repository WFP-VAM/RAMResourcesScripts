...
Variable Labels PDisabAge  "What is the age of ${PDisabName}?".
Variable Labels PDisabSex "What is the sex of ${PDisabName}?".
Variable Labels PDisabSee "Does ${PDisabName} have difficulty seeing, even if wearing glasses? Would you say…".
Variable Labels PDisabHear "Does ${PDisabName} have difficulty hearing, even if using a hearing aid(s)? Would you say…".
Variable Labels PDisabWalk  "Does ${PDisabName} have difficulty walking or climbing steps? Would you say…".
Variable Labels  PDisabRemember "Does ${PDisabName} have difficulty walking or climbing steps? Would you say…".
Variable Labels  PDisabUnderstand "Using your usual language, does ${PDisabName} have difficulty communicating, for example understanding or being understood? Would you say…".
Variable Labels  PDisabWash "Does ${PDisabName} have difficulty with self-care, such as washing all over or dressing? Would you say…".


Value labels HHAsstWFPRecCashYN1Y HHAsstWFPRecInKindYN1Y  HHAsstWFPRecCapBuildYN1Y 0 'No' 1 'Yes'.
Value labels PDisabSex 0 'Female' 1 'Male'.
Value labels PDisabSee PDisabHear PDisabWalk PDisabRemember PDisabUnderstand PDisabWash 1 'No difficulty' 2 'Some difficulty' 3 'A lot of difficulty' 4 'Cannot do at all' 888 "Don't know" 999 'Refuse'.
...
Value labels PDisabCat3 0 "without disability (category 3 criteria)" 1 "with disability (category 3 criteria)".
