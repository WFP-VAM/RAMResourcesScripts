...
tabstat HHExpFCer_Purch_MN_7D HHExpFCer_GiftAid_MN_7D HHExpFCer_Own_MN_7D ///
    ...
    HHExpFBev_Purch_MN_7D HHExpFBev_GiftAid_MN_7D HHExpFBev_Own_MN_7D ///
    HHExpFOut_Purch_MN_7D HHExpFOut_GiftAid_MN_7D HHExpFOut_Own_MN_7D, ///
    statistics(mean median min max) columns(variables)
...
*--------------------------------------------------------------------
* Aggregate FOOD expenditures (purchases + Gift/aid + own production)
*--------------------------------------------------------------------
gen HHExpF_ECMEN = HHExp_Food_Purch_MN_1M + HHExp_Food_GiftAid_MN_1M + HHExp_Food_Own_MN_1M

*--------------------------------------------------------------------
* NON-FOOD ECMEN uses cash/credit and Gift/aid expenditures
*--------------------------------------------------------------------
gen HHExpNF_ECMEN = HHExpNFTotal_Purch_MN_1M + HHExpNFTotal_GiftAid_MN_1M
...
*--------------------------------------------------------------------
* Create ECMEN indicator INCLUDING assistance
*--------------------------------------------------------------------
...
label define ECMENincllbl 1 "Above MEB" 0 "Below MEB"
label values ECMEN_inclAsst ECMENincllbl

tabulate ECMEN_inclAsst
...
*--------------------------------------------------------------------
* Create ECMEN indicator (SMEB threshold), INCLUDING assistance
*--------------------------------------------------------------------
...
label define SMEBincllbl 1 "Above SMEB" 0 "Below SMEB"
label values ECMEN_inclAsst_SMEB SMEBincllbl

tabulate ECMEN_inclAsst_SMEB