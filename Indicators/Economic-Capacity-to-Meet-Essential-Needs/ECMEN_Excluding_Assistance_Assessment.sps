...
COMPUTE HHExpF_ECMEN= HHExp_Food_Purch_MN_1M + HHExp_Food_Own_MN_1M.
EXECUTE.
...
COMPUTE HHAsstCBTRec = HHAsstWFPCBTRecTot + HHAsstUNNGOCBTRecTot.
EXECUTE.
...
COMPUTE HHAsstCBTRec_1M = HHAsstCBTRec/3.
EXECUTE.
...
RECODE HHAsstCBTRec_Cons_1M (SYSMIS = 0). 
EXECUTE.

COMPUTE HHExp_ECMEN = HHExp_ECMEN - HHAsstCBTRec_Cons_1M. 
EXECUTE.
...
VARIABLE LABELS ECMEN_exclAsst  'Economic capacity to meet essential needs - excluding assistance'.
EXECUTE.
...
VARIABLE LABELS ECMEN_exclAsst_SMEB  'Economic capacity to meet essential needs - SMEB - excluding assistance'.
EXECUTE.
...
FREQUENCIES ECMEN_exclAsst_SMEB.				   
