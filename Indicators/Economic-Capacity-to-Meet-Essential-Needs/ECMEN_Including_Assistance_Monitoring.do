********************************************************************************
 * STATA Syntax for the Economic Capacity to Meet Essential Needs (ECMEN) – Version including assistance (for monitoring)
 *******************************************************************************
...
egen HHExpF_ECMEN=rowtotal(HHExp_Food_Purch_MN_1M HHExp_Food_GiftAid_MN_1M HHExp_Food_Own_MN_1M)

*Aggregate NF expenditures and value of consumed non-food from gifts/assistance
egen HHExpNF_ECMEN=rowtotal(HHExpNFTotal_Purch_MN_1M HHExpNFTotal_GiftAid_MN_1M)
...
gen ECMEN_inclAsst=PCExp_ECMEN > MEB if (PCExp_ECMEN!=. & MEB!=.) // Make sure to rename MEB variable as appropriate

lab var ECMEN_inclAsst "Economic capacity to meet essential needs - including assistance"
lab def ECMEN 1 "Above MEB" 0 "Below MEB"
lab val ECMEN_inclAsst ECMEN

* Compute the indicator (use weights when applicable!)
tab ECMEN_inclAsst

*** 4.b SMEB (when applicable)

* Define variable indicating if PC Household Economic Capacity is equal or greater than SMEB
gen ECMEN_inclAsst_SMEB=PCExp_ECMEN > SMEB if (PCExp_ECMEN!=. & SMEB!=.) // Make sure to rename SMEB variable as appropriate
lab var ECMEN_inclAsst_SMEB "Economic capacity to meet essential needs - SMEB - including assistance"
lab def ECMEN_SMEB 1 "Above SMEB" 0 "Below SMEB"
lab val ECMEN_inclAsst_SMEB ECMEN_SMEB

* Compute the indicator (use weights when applicable!)
tab ECMEN_inclAsst_SMEB					   
